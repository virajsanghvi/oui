...
export const WithRadioGroup: Story = {
  render: (args) => (
    <div className="space-y-3">
      <Label className="text-base font-medium" {...args}>
...
export const Disabled: Story = {
  render: (args) => (
    <div className="space-y-2">
      <Label htmlFor="disabled-input" className="opacity-50" {...args}>
        Disabled Field
      </Label>
...
export const Showcase: Story = {
  render: () => (
    <div className="space-y-8">
      <div>
        <h3 className="text-lg font-semibold mb-4">Label Examples</h3>
        <div className="space-y-6">
          <div>
            <p className="text-sm font-medium mb-4">Basic Input</p>
            <div className="space-y-2">
          ...
          <div>
            <p className="text-sm font-medium mb-4">With Checkbox</p>
            <div className="flex items-center space-x-2">
              <Checkbox id="showcase-terms" />
              <Label htmlFor="showcase-terms" className="text-sm font-normal">
          ...
          <div>
            <p className="text-sm font-medium mb-4">With Switch</p>
            <div className="flex items-center space-x-2">
          ...
          <div>
            <p className="text-sm font-medium mb-4">Required Field</p>
            <div className="space-y-2">
