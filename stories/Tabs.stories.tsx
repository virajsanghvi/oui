...
export const Vertical: Story = {
    render: (args) => (
        <Tabs {...args} orientation="vertical" className="flex w-[600px] h-[400px]">
            <TabsList className="flex-col h-fit w-[200px] mr-4">
                        ...
                        <CardContent className="space-y-4">
                            <div className="space-y-3">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-medium">2,847 / 5,000 requests</span>
                                </div>
                                <div className="flex justify-between">
                                ...
                                <div className="flex items-center justify-between p-3 border rounded-md">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-muted-foreground">Documentation and notes</p>
                                        </div>
                                    </div>
                                    <Button size="sm">Connect</Button>
                                </div>
        ...
        <Tabs {...args} className="w-[350px]">
            ...
            <TabsContent value="week" className="mt-4">
                <div className="space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">Page views this week</p>
...
export const Interactive: Story = {
    render: (args) => {
        ...
        return (
            <Tabs {...args} value={activeTab} onValueChange={setActiveTab} className="w-[450px]">
                <TabsList>
                    <TabsTrigger value="dashboard">Dashboard</TabsTrigger>
                    <TabsTrigger value="messages">
                        Messages
                        {notifications > 0 && (
                            <Badge className="ml-2 rounded-full min-w-5 h-5 px-1.5">
                                {notifications}
                            </Badge>
                        )}
                    </TabsTrigger>
                                ...
                                <div className="p-3 border rounded-md">
                                    <div className="flex justify-between items-start">
                                        <div>
                                            ...
                                            <p className="text-sm text-muted-foreground">The design review is complete...</p>
                                        </div>
                                ...
                                <div className="p-3 border rounded-md">
                                    <div className="flex justify-between items-start">
                                        <div>
                                            ...
                                            <p className="text-sm text-muted-foreground">Don't forget about tomorrow's...</p>
                                        </div>
                                ...
                                <div className="p-3 border rounded-md">
                                    <div className="flex justify-between items-start">
                                        <div>
                                            ...
                                            <p className="text-sm text-muted-foreground">Scheduled maintenance window...</p>
                                        </div>
            ...
            <TabsContent value="preview" className="mt-4">
                <Card>
                    ...
                    <CardContent>
                        ...
                        <div className="mt-4 p-4 border-2 border-dashed border-muted-foreground/25 rounded-md bg-muted/10">
                            <div className="flex items-center justify-center h-32">
                                <div className="text-center">
                                    ...
                                    <p className="text-sm text-muted-foreground">Component Preview Area</p>
                                </div>
                            </div>
                        </div>
                    </CardContent>
            ...
            <TabsContent value="code" className="mt-4">
                <Card>
                    ...
                    <CardContent>
                        ...
                        <div className="mt-4 p-4 bg-muted/50 rounded-md font-mono text-sm">
                            <div className="space-y-1">
                                <div><span className="text-blue-600">import</span> <span className="text-green-600">React</span> <span className="text-blue-600">from</span> <span className="text-orange-600">'react'</span>;</div>
                                <div></div>
                                <div><span className="text-blue-600">export</span> <span className="text-blue-600">function</span> <span className="text-purple-600">MyComponent</span>() {`{`}</div>
                                <div className="ml-4"><span className="text-blue-600">return</span> (</div>
                                <div className="ml-8">&lt;<span className="text-red-600">div</span> <span className="text-green-600">className</span>=<span className="text-orange-600">"container"</span>&gt;</div>
                        ...
                        <div className="mt-4 space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="p-3 bg-muted/50 rounded-md">
                                    ...
                                    <div className="mt-2 space-y-1">
                                        <div className="text-xs">Padding: 8px</div>
                                        <div className="text-xs">Margin: 4px</div>
                                        <div className="text-xs">Gap: 8px</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">Display alignment grid</p>
                                    </div>
                                    <Checkbox defaultChecked />
                                </div>
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">Update preview automatically</p>
                                    </div>
                                    <Checkbox />
                                </div>
                                <div className="flex items-center justify-between">
    ...
    render: () => (
        <div className="space-y-8 max-w-4xl">
            ...
            <div>
                ...
                <Tabs defaultValue="profile" orientation="vertical" className="flex w-[500px] h-[200px]">
                    <TabsList className="flex-col h-fit w-[150px] mr-4">
                    ...
                    <div className="flex-1">
                        ...
                        <TabsContent value="security">
                            <div className="p-4 border rounded-md h-full">
                                ...
                                <p className="text-sm text-muted-foreground">Configure authentication and privacy options.</p>
                            </div>
                        </TabsContent>
                        <TabsContent value="billing">
                            <div className="p-4 border rounded-md h-full">
                                <h4 className="font-medium mb-2">Billing Information</h4>
                                <p className="text-sm text-muted-foreground">View usage and manage payment methods.</p>
                            </div>
                        </TabsContent>
                    </div>
                </Tabs>
            ...
            {/* Compact tabs */}
            <div>
                <h3 className="text-lg font-semibold mb-4">Compact Tabs</h3>
            ...
            <div>
                ...
                <Tabs defaultValue="basic" className="w-[350px]">
                    <TabsList>
