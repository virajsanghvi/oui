...
async function main() {
  ...
  if (updatedCount > 0) {
    ...
    console.log('   • Updated imports for extended components to use @/components')
    console.log()
    console.log('⚠️  Please review the changes and test your components!')
  } else {
    console.log()
    console.log('✨ No changes needed - all shadcn components are already properly configured!')
  }
}
